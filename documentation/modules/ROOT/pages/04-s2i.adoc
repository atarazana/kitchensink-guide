...
<2> Install Oracle driver which is not installed by default
<3> In 7.2 PostgreSQL driver is already installed but this is not the case in 7.4
...
Run this command to have a look to the pod logs.
